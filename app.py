...
# --- DIAGNOSTIC: Moved to route ---
# Keeping startup fast and non-blocking.
# --- DIAGNOSTIC END ---
...
TRANSLATIONS = {
    ...
    "Malayalam": {
        ...
        "error_manual_fallback": "സ്കാന്‍ ആവുന്നില്ലേ? മരുന്നിന്റെ പേര് ടൈപ്പ് ചെയ്ത് AI യോട് ചോദിക്കൂ",
        "role_myself": "ഞാൻ",
        "role_title": "ഇത് ആർക്കുവേണ്ടിയാണ്?",
        "role_add": "➕ ചേർക്കുക",
